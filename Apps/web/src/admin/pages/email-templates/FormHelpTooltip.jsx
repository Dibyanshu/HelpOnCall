...
export default function FormHelpTooltip({ title, description, example }) {
  return (
    <span className="group relative inline-flex items-center">
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute left-1/2 top-full z-50 mt-2 w-72 -translate-x-1/2 rounded-xl border border-white/35 bg-white/30 px-3 py-2 text-left opacity-0 shadow-xl backdrop-blur-md transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100"
      >
