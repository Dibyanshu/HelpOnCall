export default function AboutUsCard({
  ...
  return (
    <section aria-label="About us highlight" className="w-full">
      <div className="rounded-2xl border border-slate-200/80 bg-white/95 p-6 shadow-2xl backdrop-blur sm:p-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <a
            href={buttonLink}
            className="inline-flex w-full items-center justify-center rounded-lg bg-slate-700 px-5 py-3 text-sm font-semibold text-white transition-colors duration-200 hover:bg-slate-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-700 md:w-auto"
          >
            {buttonLabel}
          </a>
        </div>
